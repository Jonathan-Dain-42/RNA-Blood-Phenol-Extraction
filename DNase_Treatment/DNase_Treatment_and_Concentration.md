# Post total-RNA Extraction DNase Treatment and Concentration
Jonathan Dain
2026-08-10
...
1.  1 x DNase Reaction Tube (2 mL): Label the lid with the sample ID.
    (This is where the initial 65uL DNase reaction will take place).

2.  1 x Primary Elution Tube (2 mL): Label the lid and side with the
    sample ID and the letter “E” (eluent). (You will transfer the Zymo
    column into this tube for the final 55uL water elution).

3.  1 x GENEWIZ Tube (RNase-free 1.5mL): Label the lid and side clearly
    with the sample ID and “GW” (ensure this matches GENEWIZ’s specific
    online submission naming rules). **i.e. MDPXXX**
...
| QC Tube (0.5mL)           | <span style="color: pink;">Pink</span> |
...
a master mix for our DNase solution since pipetting exactly 1uL of
TurboDNase is very tricky.

| Reagent | For 1 Sample | For 8 samples (+ 1 extra) | For 10 Samples (+ 1 extra) |
|----|----|----|----|
| 10X TurboDNase Buffer | 6.5uL | 58.5uL | 71.5uL |
| Turbo DNase (2U) | 1uL | 9uL | 11uL |
| Nuclease-free H2O | 2.5uL | 22.5uL | 27.5uL |
| Total Volume | 10uL | 90uL | 110uL |

Turbo DNase Master Mix reagent list and volumes.

1.  Thaw TurboDNase Buffer on ice. Ensure that is is fully liquid and
    homogenized by vortexing briefly.
2.  Keep TurboDNase Enzyme in the Strata-cooler in the 4ºC mini-fridge.
3.  Create DNase master mix according to the table above (typically this
    will be 10 samples + 1 extra). Spike in the TurboDNase at the last
    moment. **Note that the DNase enzyme is 50% glycerol and as such is
    highly viscous so care should be taken at this step.**
...
3.  In the archive labeled tube aliquot the remaining ~19-20uL of eluent
    and cap.
...
6.  Once qubit concentrations are known, label a new RNase-free 1.5mL
    tube and dilute sample to a concentration of ~2,500 pg/ul in 3-5uL
    for the tapestation assay.
