...
-   [ ] Do you have enough 3 mm beads for the number of samples you
    have?
...
12. Once clot samples are in the tubes, parafilm the tubes and place
    ...
    incubate for 30 minutes. The mixing speed should be set to \~8 on
    the mixer.
...
> 10 [require]{.underline} manual input from user.**
